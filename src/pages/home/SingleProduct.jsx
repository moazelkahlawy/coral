      ...
      <div className="p-3 max-w-7xl m-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-6 h-max">
            ...
            <div>
              ...
              <p className="mt-3 text-gray-600 text-base leading-6 text-justify sm:text-left sm:mt-4">
                ...
                sed adipisci non molestiae maiores. Autem architecto dolorum est
                itaque tempore sint facilis assumenda, amet doloribus nesciunt
                rem consequatur, accusantium similique! Lorem ipsum dolor, sit
                amet
              </p>
        ...
        <div className="text-black/75 mt-12">
          <p>
            ...
            maxime dolorum maiores nihil minus exercitationem pariatur, qui
            illum esse ad sit suscipit quas quidem obcaecati, ab quia eius
            soluta. Aperiam.
          </p>
          <p>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptate
